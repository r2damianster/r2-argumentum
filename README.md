...
Probado de punta a punta contra producción en varias sesiones de prueba manual (ver `docs/10-guia-prueba-manual-chrome.md` para el procedimiento y `docs/06-pendientes.md` para el detalle de lo cerrado). Cuenta con una suite de pruebas automatizadas en Vitest (**221 tests pasando en 21 archivos de prueba**, ejecutables con `npm test`).
