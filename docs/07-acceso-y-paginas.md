...
- Desde aquí el profesor: crea/carga un Programa de Debate, elige el modo de calificación, el idioma de los argumentos (español o inglés) y las posturas, controla el avance de fases, proyecta el grafo en vivo (modo proyección: «Proyectar aquí» en la misma pestaña o «Proyectar en otra ventana» para el proyector mientras la laptop conserva los controles; la ventana aparte es solo una pantalla que recibe el estado de la consola por `BroadcastChannel`, sin segunda conexión a Ably ni segundo motor), ve la pantalla de cualquier participante (vista espejo, solo lectura), recibe avisos operativos, ve el ranking por postura, ve el ranking parcial o cierra el debate cuando quiera, descarga el JSON de la sesión, genera el informe en PDF (diálogo de impresión → «Guardar como PDF») y, con el debate cerrado, inicia uno nuevo sin cerrar su sesión. Los co-moderadores se sortean solos al iniciar.
